...
export function InstagramIcon() {
  return (
    <FaInstagram className="mr-2 h-7 w-7 fill-slate-400 group-hover:fill-slate-600" />
  )
}

export function SoundcloudIcon() {
  return (
    <FaSoundcloud className="mr-2 h-7 w-7 fill-slate-400 group-hover:fill-slate-600" />
  )
}
