...
export function MuteButton({ player }) {
  return (
    <button
      type="button"
      className="hover:black group relative rounded-md focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 md:order-none"
    ...
    >
      ...
      <MuteIcon
        muted={player.muted}
        className="h-6 w-6 fill-slate-200 stroke-slate-200 group-hover:fill-slate-200 group-hover:stroke-slate-400"
      />
    </button>
  )
}
