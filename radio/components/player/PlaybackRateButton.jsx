...
export function PlaybackRateButton({ player }) {
  ...
  return (
    <button
      type="button"
      className="relative flex h-6 w-6 items-center justify-center  rounded-md  hover:bg-black hover:text-black"
      onClick={() => {
    ...
    >
      ...
      <playbackRate.icon className="h-4 w-4 hover:text-gray-400" />
    </button>
  )
}
